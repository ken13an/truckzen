...
const T: Record<string, Record<string, string>> = {
  en: {
    ...
    confirmed_sub: "Your request is under shop review. We'll send updates to",
  ...
  es: {
    ...
    submitting: 'Enviando...',
    confirmed_title: 'Solicitud Recibida',
    confirmed_sub: 'Su solicitud está en revisión. Le enviaremos actualizaciones a',
  ...
  ru: {
    ...
    submitting: 'Отправка...',
    confirmed_title: 'Заявка Получена',
    confirmed_sub: 'Ваша заявка находится на рассмотрении. Обновления будут отправлены на',
  ...
  uz: {
    ...
    confirmed_title: 'So\'rov Qabul Qilindi',
    confirmed_sub: 'So\'rovingiz ko\'rib chiqilmoqda. Yangiliklar yuboriladi:',
