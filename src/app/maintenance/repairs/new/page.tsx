...
export default function NewRepairPage() {
  ...
  return (
    <div style={S.page}>
      <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 28, color: 'var(--tz-text)', marginBottom: 4 }}>New Road Repair</div>
      <div style={{ fontSize: 12, color: 'var(--tz-textSecondary)', marginBottom: 20 }}>Log a road repair for a fleet truck.</div>

      {error && <div style={S.error}>{error}</div>}

      <form onSubmit={submit}>
        <div style={S.card}>
          <div style={{ fontSize: 12, fontWeight: 700, color: 'var(--tz-text)', marginBottom: 12 }}>Repair Details</div>
          <div style={S.row3}>
            <div>
        ...
        <div style={S.card}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
            ...
            <button type="button" onClick={() => setLines(l => [...l, { description: '', part_number: '', quantity: '1', unit_cost: '0', line_type: 'part' }])} style={{ display: 'flex', alignItems: 'center', gap: 4, padding: '5px 10px', background: 'rgba(29,111,232,.1)', border: '1px solid rgba(29,111,232,.2)', borderRadius: 6, color: 'var(--tz-accentLight)', fontSize: 11, cursor: 'pointer', fontFamily: FONT }}>
          ...
          <div style={{ textAlign: 'right', marginTop: 10, fontFamily: MONO, fontSize: 14, fontWeight: 700, color: 'var(--tz-text)' }}>
