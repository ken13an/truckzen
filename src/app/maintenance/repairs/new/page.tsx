...
export default function NewRepairPage() {
  ...
  return (
    <div style={S.page}>
      <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 28, color: '#F0F4FF', marginBottom: 4 }}>New Road Repair</div>
      <div style={{ fontSize: 12, color: '#7C8BA0', marginBottom: 20 }}>Log a road repair for a fleet truck.</div>

      {error && <div style={S.error}>{error}</div>}

      <form onSubmit={submit}>
        <div style={S.card}>
          <div style={{ fontSize: 12, fontWeight: 700, color: '#F0F4FF', marginBottom: 12 }}>Repair Details</div>
          <div style={S.row3}>
            <div>
        ...
        <div style={S.card}>
          ...
          <div style={{ textAlign: 'right', marginTop: 10, fontFamily: MONO, fontSize: 14, fontWeight: 700, color: '#F0F4FF' }}>
