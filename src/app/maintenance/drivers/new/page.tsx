...
export default function NewDriverPage() {
  ...
  const S: Record<string, React.CSSProperties> = {
    page: { background: 'var(--tz-bg)', minHeight: '100vh', color: 'var(--tz-text)', fontFamily: FONT, padding: 24, maxWidth: 680, margin: '0 auto' },
  ...
  return (
    <div style={S.page}>
      <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 28, color: 'var(--tz-text)', marginBottom: 4 }}>New Driver</div>
      <div style={{ fontSize: 12, color: 'var(--tz-textSecondary)', marginBottom: 20 }}>Add a new driver to the fleet.</div>
      {error && <div style={S.error}>{error}</div>}
      <form onSubmit={submit}>
        <div style={S.card}>
          <div style={{ fontSize: 12, fontWeight: 700, color: 'var(--tz-text)', marginBottom: 12 }}>Personal Info</div>
        ...
        <div style={S.card}>
          <div style={{ fontSize: 12, fontWeight: 700, color: 'var(--tz-text)', marginBottom: 12 }}>CDL Information</div>
          <div style={S.row3}>
        ...
        <div style={S.card}>
          <div style={{ fontSize: 12, fontWeight: 700, color: 'var(--tz-text)', marginBottom: 12 }}>Medical & Compliance</div>
          <div style={S.row2}>
