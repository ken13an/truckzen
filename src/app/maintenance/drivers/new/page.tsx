...
export default function NewDriverPage() {
  ...
  const S: Record<string, React.CSSProperties> = {
    page: { background: '#060708', minHeight: '100vh', color: '#DDE3EE', fontFamily: FONT, padding: 24, maxWidth: 680, margin: '0 auto' },
  ...
  return (
    <div style={S.page}>
      <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 28, color: '#F0F4FF', marginBottom: 4 }}>New Driver</div>
      <div style={{ fontSize: 12, color: '#7C8BA0', marginBottom: 20 }}>Add a new driver to the fleet.</div>
      ...
      <form onSubmit={submit}>
        ...
        <div style={S.card}>
          <div style={{ fontSize: 12, fontWeight: 700, color: '#F0F4FF', marginBottom: 12 }}>CDL Information</div>
          <div style={S.row3}>
        ...
        <div style={S.card}>
          <div style={{ fontSize: 12, fontWeight: 700, color: '#F0F4FF', marginBottom: 12 }}>Medical & Compliance</div>
          <div style={S.row2}>
