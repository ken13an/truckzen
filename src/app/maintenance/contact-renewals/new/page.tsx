...
export default function NewContactRenewalPage() {
  ...
  const S: Record<string, React.CSSProperties> = {
    page: { background: '#060708', minHeight: '100vh', color: '#DDE3EE', fontFamily: FONT, padding: 24, maxWidth: 520, margin: '0 auto' },
  ...
  return (
    <div style={S.page}>
      <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 28, color: '#F0F4FF', marginBottom: 20 }}>New Contact Renewal</div>
