...
export default function NewServiceReminderPage() {
  ...
  const S: Record<string, React.CSSProperties> = {
    page: { background: th.bg, minHeight: '100vh', color: th.text, fontFamily: FONT, padding: 24, maxWidth: 600, margin: '0 auto' },
  ...
  return (
    <div style={S.page}>
      <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 28, color: th.text, marginBottom: 20 }}>New Service Reminder</div>
