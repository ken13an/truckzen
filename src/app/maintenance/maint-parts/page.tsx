...
export default MaintListPage({
  ...
  columns: [
    ...
    { key: 'quantity_on_hand', label: 'Qty', render: r => <span style={{ fontWeight: 700, color: r.quantity_on_hand === 0 ? RED : r.quantity_on_hand <= (r.reorder_point || 2) ? AMBER : undefined }}>{r.quantity_on_hand}</span> },
