...
export default function NewServiceProgramPage() {
  ...
  return (
    <div style={S.page}>
      <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 28, color: th.text, marginBottom: 20 }}>New Service Program</div>
      ...
      <form onSubmit={submit}>
        ...
        <div style={S.card}>
          ...
          <div style={{ maxHeight: 200, overflowY: 'auto', marginTop: 6 }}>
            {assets.map(a => (
              <label key={a.id} style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '4px 0', cursor: 'pointer', fontSize: 12, color: th.text }}>
