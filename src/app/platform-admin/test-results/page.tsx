    ...
    <div>
      ...
      {selectedResult && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,.7)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9998 }} onClick={() => setSelectedResult(null)}>
          <div style={{ background: t.bgCard, border: '1px solid rgba(255,255,255,.08)', borderRadius: 12, padding: 24, maxWidth: 700, width: '95%', maxHeight: '80vh', overflow: 'auto' }} onClick={e => e.stopPropagation()}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12, marginBottom: 24 }}>
        {[
          ...
          return (
            <div key={card.label} style={{ background: t.bgCard, border: '1px solid rgba(255,255,255,.08)', borderRadius: 12, padding: 16 }}>
      ...
      <div style={{ background: t.bgCard, border: '1px solid rgba(255,255,255,.08)', borderRadius: 12, overflow: 'hidden' }}>
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            {results.map((r, idx) => (
              <tr key={r.id}>
                <td style={{ padding: '10px 12px', fontSize: 11, color: t.textTertiary, borderBottom: '1px solid rgba(255,255,255,.04)', fontFamily: "'IBM Plex Mono', monospace" }}>
                  #{total - ((page - 1) * 20 + idx)}
                </td>
                <td style={{ padding: '10px 12px', fontSize: 12, color: t.text, borderBottom: '1px solid rgba(255,255,255,.04)', fontWeight: 500 }}>{r.scenario_name}</td>
                <td style={{ padding: '10px 12px', fontSize: 11, color: t.textTertiary, borderBottom: '1px solid rgba(255,255,255,.04)', fontFamily: "'IBM Plex Mono', monospace", whiteSpace: 'nowrap' }}>{fmtTime(r.started_at)}</td>
                <td style={{ padding: '10px 12px', fontSize: 11, color: t.textSecondary, borderBottom: '1px solid rgba(255,255,255,.04)', fontFamily: "'IBM Plex Mono', monospace" }}>{fmtDuration(r.duration_ms)}</td>
                <td style={{ padding: '10px 12px', fontSize: 11, color: t.textSecondary, borderBottom: '1px solid rgba(255,255,255,.04)', fontFamily: "'IBM Plex Mono', monospace", textAlign: 'center' }}>{r.total_steps}</td>
                ...
                <td style={{ padding: '10px 12px', fontSize: 11, color: r.failed_steps > 0 ? '#D94F4F' : t.textTertiary, borderBottom: '1px solid rgba(255,255,255,.04)', fontFamily: "'IBM Plex Mono', monospace", textAlign: 'center' }}>{r.failed_steps}</td>
