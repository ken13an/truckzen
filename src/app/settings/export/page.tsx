...
export default function ExportPage() {
  ...
  return (
    <div style={{ fontFamily: FONT, color: 'var(--tz-text)', background: 'var(--tz-bg)', minHeight: '100vh', maxWidth: 700, margin: '0 auto', padding: '24px' }}>
      ...
      {done && (
        <div style={{ marginTop: 16, padding: '12px 16px', background: 'var(--tz-successBg)', border: '1px solid var(--tz-success)', borderRadius: 8, fontSize: 13, color: '#16A34A', fontWeight: 600 }}>
