...
export default function KioskCodePage() {
  ...
  if (status === 'loading') {
    return <div style={{ background: 'var(--tz-bg)', color: 'var(--tz-text)', fontFamily: "'Instrument Sans', sans-serif", minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
  ...
  if (status === 'error') {
    return <div style={{ background: 'var(--tz-bg)', color: 'var(--tz-text)', fontFamily: "'Instrument Sans', sans-serif", minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ textAlign: 'center', maxWidth: 400, padding: 40 }}>
        ...
        <p style={{ fontSize: 12, color: 'var(--tz-textTertiary)' }}>Contact your shop administrator.</p>
      </div>
    </div>
  }
