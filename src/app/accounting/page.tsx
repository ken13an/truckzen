...
export default function AccountingPage() {
  ...
  useEffect(() => {
    async function load() {
      ...
      setStats({
        revenue_mtd:    paid?.reduce((s: number, i: any) => s + (i.total || 0), 0) || 0,
        outstanding:    sent?.reduce((s: number, i: any) => s + (i.balance_due || 0), 0) || 0,
        overdue:        sent?.filter((i: any) => i.due_date && i.due_date < today).reduce((s: number, i: any) => s + (i.balance_due || 0), 0) || 0,
